...
(function () {  //method from: https://community.canvaslms.com/thread/22500-mobile-javascript-development
    ...
    function ou_domReady () {
        setTimeout(function(){ 
            //MOB divUserContent = document.querySelector('div.show-content.user_content');
            divUserContent = document.getElementById('content'); 
            ou_getH2s();
        }, 500);
    }
    ...
    function ou_createMenu(h2MenuItems) {
        if(divUserContent) {
            ...
            //MOB var h1PageTitle = divUserContent.getElementsByTagName('h1')[0];

            //MOB insertAfter(scrollNav,h1PageTitle);

            divUserContent.prepend(scrollNav);
